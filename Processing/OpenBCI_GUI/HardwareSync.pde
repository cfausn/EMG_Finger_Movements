...
void serialEvent(Serial port) {
  ...
  if (openBCI.isOpenBCISerial(port)) {
    ...
    if (openBCI.get_isNewDataPacketAvailable()) {
      ...
      if(isTrial) fileoutput.writeRawData_dataPacket(dataPacketBuff[curDataPacketInd], openBCI.get_scale_fac_uVolts_per_count(), openBCI.get_scale_fac_accel_G_per_count());
    }
  } else {
